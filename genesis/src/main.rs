    ...
    let matches = App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("bootstrap_validator")
                ...
                .multiple(true)
                .required(true)
                .help("The bootstrap validator's identity, vote and stake pubkey as either a) a base58-encoded string (e.g. AKDAFBjxJ5hZ1YzDLcZsTsgs4XkoZQjacyWrSZmQobTVlike produced by 'solana-keygen pubkey') or b) a file containing a base58-encoded pub+priv keypair, serialized to JSON array (e.g. [8,239,....245,104])"),
        )
        .arg(
        ...
        .arg(
            Arg::with_name("faucet_pubkey")
                ...
                .help("The faucet's pubkey as either a) a base58-encoded string (e.g. AKDAFBjxJ5hZ1YzDLcZsTsgs4XkoZQjacyWrSZmQobTVlike produced by 'solana-keygen pubkey') or b) a file containing a base58-encoded pub+priv keypair, serialized to JSON array (e.g. [8,239,....245,104])"),
        )
        .arg(
